  ...
  <body>
              ...
              <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg">
                  <a class="navbar-brand" href="index.html">
                    <img src="{{ asset ('assets1/img/logo/logo.svg')}}" alt="Logo" />
                  </a>
          ...
          <div class="row align-items-end">
            ...
            <div class="col-lg-6">
              <div class="hero-image">
                <img src="{{ asset ('assets1/img/hero/hero-2/hero-img.svg')}}" alt="" class="wow fadeInRight" data-wow-delay=".2s">
                <img src="{{ asset ('assets1/img/hero/hero-2/paattern.svg')}}" alt="" class="shape shape-1">
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="services" class="feature-section feature-style-2">
      ...
      <div class="feature-img wow fadeInLeft" data-wow-delay=".2s">
        <img src="{{ asset ('assets1/img/feature/feature-2-1.svg')}}" alt="">
      </div>
    </section>
		<!-- ========================= feature style-2 end ========================= -->
        ...
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="about-image wow fadeInLeft" data-wow-delay=".2s">
              <img src="{{ asset ('assets1/img/about/about-3/about-img.jpg')}}" alt="">
            </div>
          </div>
          <div class="col-lg-6">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-4 col-md-8 col-sm-10">
            <div class="single-pricing wow fadeInUp" data-wow-delay=".2s">
              <div class="image">
                <img src="{{ asset ('assets1/img/pricing/pricing-1/pricing-1.svg')}}" alt="">
              </div>
              <h6>Basic Design</h6>
              <h4>Web Design</h4>
              <h3>$ 29.00</h3>
          ...
          <div class="col-lg-4 col-md-8 col-sm-10">
            <div class="single-pricing active wow fadeInUp" data-wow-delay=".4s">
              ...
              <div class="image">
                <img src="{{ asset ('assets1/img/pricing/pricing-1/pricing-2.svg')}}" alt="">
              </div>
          ...
          <div class="col-lg-4 col-md-8 col-sm-10">
            <div class="single-pricing wow fadeInUp" data-wow-delay=".6s">
              <div class="image">
                <img src="{{ asset ('assets1/img/pricing/pricing-1/pricing-3.svg')}}" alt="">
              </div>
              <h6>Pro Design</h6>
        ...
        <div class="row justify-content-center">
          <div class="col-xl-3 col-md-6 col-sm-10">
            <div class="single-team wow fadeInUp" data-wow-delay=".2s">
              <div class="image">
                <img src="{{ asset ('assets1/img/team/team-1/team-1.png')}}" alt="">
              </div>
              <div class="info">
                <h6>John Doe</h6>
          ...
          <div class="col-xl-3 col-md-6 col-sm-10">
            <div class="single-team wow fadeInUp" data-wow-delay=".4s">
              <div class="image">
                <img src="{{ asset ('assets1/img/team/team-1/team-2.png')}}" alt="">
              </div>
              <div class="info">
                <h6>David Endow</h6>
          ...
          <div class="col-xl-3 col-md-6 col-sm-10">
            <div class="single-team wow fadeInUp" data-wow-delay=".6s">
              <div class="image">
                <img src="{{ asset ('assets1/img/team/team-1/team-3.png')}}" alt="">
              </div>
              <div class="info">
          ...
          <div class="col-xl-3 col-md-6 col-sm-10">
            <div class="single-team wow fadeInUp" data-wow-delay=".8s">
              <div class="image">
                <img src="{{ asset ('assets1/img/team/team-1/team-4.png')}}" alt="">
              </div>
              <div class="info">
                <h6>Gray Simon</h6>
        ...
        <div class="row">
          <div class="col-lg-7">
            <div class="contact-form-wrapper">
              <form action="{{ asset ('assets1/php/contact.php')}}" method="POST">
                <div class="row">
                  <div class="col-md-6">
          ...
          <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-6">
              <div class="footer-widget wow fadeInUp" data-wow-delay=".2s">
                <div class="logo">
                  <a href="#0"> <img src="{{ asset ('assets1/img/logo/logo.svg')}}" alt=""> </a>
                </div>
    ...
    <!-- ========================= JS here ========================= -->
    <script src="{{ asset ('assets1/js/bootstrap.5.0.0.alpha-2-min.js')}}"></script>
    <script src="{{ asset ('assets1/js/count-up.min.js')}}"></script>
